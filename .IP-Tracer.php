...
function About() {
  ...
  echo <<<EOL
         ...
         \033[01;33mAuthor \033[01;37m:- \033[01;36mCodizium
         \033[01;33mPowered By \033[01;37m:- \033[01;36mCodizium
...
function upd() {
  ...
  sleep(1);
  system("cd ~/ && git clone https://github.com/codizium/IP-Tracer.git");
  system("cd ~/ && sudo git clone https://github.com/codizium/IP-Tracer.git");
